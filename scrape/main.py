...
def scrape_all_products(category_url):
    ...
    products = scrape_megekko(category_url + "/PC-Voedingen-PSU-")
    all_products["PSU"] = products

    # Save to JSON
    with open("megekko_products-psu.json", "w", encoding="utf-8") as json_file:
...
def main():
    category_url = "https://www.megekko.nl/Computer/Componenten/Voedingen/"
